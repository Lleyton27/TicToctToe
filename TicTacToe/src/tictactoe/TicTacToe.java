...
public class TicTacToe {
    ...
    /**
     * Este es el main y lo usamos para crear todo el bloque del código, es la principal
     */
    ...
    /**
     * Aqui va recorriendo y llenando todos los espacios que hay en el 3 en raya.
     * @param taulerJoc 
     */
    ...
    /**
     * Esto crea las tablas del juego, paso a paso
     * @param taulerJoc 
     */
    ...
    /*
     * @param i Aqui te returna un resultado depende de lo que ponga el usuario. 
    */
    ...
    */
    ...
    /*
     * @param taulerJoc Aqui empieza el turno del contrincante. 
    */
    ...
    /**
     * 
     * @param taulerJoc Aqui empieza el turno del jugador
     */
    public static void tirJugador(int[][] taulerJoc){
        ...
        System.out.println("[X] Entra la columna (1-3)");
        int x = sc.nextInt();
        System.out.println("[Y] Entra la fila (1-3)");
        int y = sc.nextInt();
